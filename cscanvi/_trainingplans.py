...
class CLSemiSupervisedTrainingPlan(TrainingPlan):
    """
...
#         ewc_importance: float = 0.0,
        ...
        **loss_kwargs,
        ...
        super(CLSemiSupervisedTrainingPlan, self).__init__(
            module=module,
            lr=lr,
            weight_decay=weight_decay,
            n_steps_kl_warmup=n_steps_kl_warmup,
    ...
    def training_step(self, batch, batch_idx, optimizer_idx=0):
        ...
        _, _, scvi_losses = self.module._replay_forward(full_dataset, loss_kwargs=input_kwargs)
